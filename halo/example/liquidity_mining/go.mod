module github.com/permadao/permaswap/halo/proposal

go 1.20

require (
	github.com/ethereum/go-ethereum v1.13.10
	github.com/everVision/everpay-kits v0.0.8
	github.com/permadao/permaswap v0.0.3-0.20240328022516-12ca9dabb796
